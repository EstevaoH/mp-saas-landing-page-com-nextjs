...
INSERT INTO "new_User" ("createdAt", "email", "id", "lastName", "name", "password", "planId", "status", "updatedAt", "username") SELECT "createdAt", "email", "id", "lastName", "name", "password", "planId", "status", "updatedAt", "username" FROM "User";
DROP TABLE "User";
